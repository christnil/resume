...
export const roles = [
  ...
  {
    name: 'Full stack developer Java/AngularJS',
    description: 'When the first version of the customer portal was released I felt that I wanted to try something new and as a result the Client agreed to move me from the sales support team to the operational support team. There I started working in a developing team with a lot of work dependent on just one team member. I worked close together with the project manager to develop a working development process and implement most of the scrum model. This new role had a few different goals, set up a back-office application for reserving and finding network identifiers of different forms. Providing data for a new Service Now integration as well as setting up API:s to fetch data from Service Now API:s. The other prioritized goal was unifying the stack used to monitor the 2 recently merged networks. This meant merging data sources, set up new services to handle both networks and so on. What I take away from this role is more of the soft skills I developed. Coaching new team-members. Introducing to stake holders what a sprint demo is and doing a lot of them and so on.',
  },
];
...
export const keywords = [
  ...
  { name: 'TypeScript', involvement: 3, usage: 5, category: 'Language/Framework' },
  { name: 'Nginx', involvement: 3, usage: 5, category: 'Other' },
  { name: 'ArchiMate', involvement: 3, usage: 5, category: 'Language/Framework' },
  { name: 'Archi', involvement: 3, usage: 5, category: 'Tools', excludeFromProjectView: true },
  { name: 'RabbitMQ', involvement: 4, usage: 5, category: 'Other' },
  { name: 'IntelliJ', involvement: 4, usage: 5, category: 'Tools', excludeFromProjectView: true },
  { name: 'DataGrip', involvement: 4, usage: 5, category: 'Tools', excludeFromProjectView: true },
  { name: 'Jira', involvement: 4, usage: 5, category: 'Tools', excludeFromProjectView: true },
  { name: 'Jest', involvement: 3, usage: 4, category: 'Testing' },
  { name: 'Python', involvement: 3, usage: 2, category: 'Language/Framework' },
  { name: 'PyCharm', involvement: 4, usage: 5, category: 'Tools', excludeFromProjectView: true },
  { name: 'JUnit', involvement: 4, usage: 4, category: 'Testing' },
];